...
- **Mock data layer (Test Data since there is no backend):** a single typed mock data file centralizes all fake users, posts, notifications, and messages, keeping page components focused on UI logic rather than data shape.


## Future Improvements

- Integrate a real backend and authentication system
- Add real video upload and playback support
- Implement infinite scrolling on the Home Feed
- Add a screen time tracker showing users how long they've spent on the app, with optional daily limits and reminders, encouraging mindful usage
- Add toast notifications for actions (like, save, follow)
- Introduce Zustand for global state management as the app scales
